...
public class AdocaoService {
    ...
    public void reprovar(ReprovacaoAdocaoDto dto) {
        ...
        emailService.enviarEmail(adocao.getPet().getAbrigo().getEmail(),
                "Adoção reprovada",
                "Olá " +adocao.getPet().getAbrigo().getNome() +"!\n\nA adoção do pet " +adocao.getPet().getNome() +", solicitada em " +adocao.getData().format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss")) +" pelo tutor " +adocao.getTutor().getNome() +" foi reprovada com a seguinte justificativa: " +adocao.getJustificativaStatus() +".");
    }
}
